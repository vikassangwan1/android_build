...
$(call add_json_bool, BoardUsesQTIHardware,              $(BOARD_USES_QTI_HARDWARE))
$(call add_json_bool, BoardUsesQCOMHardware,             $(BOARD_USES_QCOM_HARDWARE))
$(call add_json_bool, TargetUsesQCOMBsp,                 $(TARGET_USES_QCOM_BSPK))
$(call add_json_bool, TargetUsesNoTrebleCamera,          $(TARGET_USES_NON_TREBLE_CAMERA))
$(call add_json_str,  TargetHeaderPath,                  $(TARGET_SPECIFIC_HEADER_PATH))
$(call add_json_bool, LegacyCam,                         $(call invert_bool,$(TARGET_HAS_LEGACY_CAMERA)))
